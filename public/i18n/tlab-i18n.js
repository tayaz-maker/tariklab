    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Images whose creator was not recorded: the portal share images, JITEM: Derin Ağ images and the Son Mahalle Bükücü icons. Provenance pending.",
        ],
      },
      {
  ...
  const CREDITS_PL = {
    ...
    sections: [
      ...
      { h: "Grafiki i łańcuch praw", lead: "Jako licencje pokazujemy tylko prawa z potwierdzonym zapisem.", items: [
        ...
        "Obrazy bez zapisanego autora: grafiki udostępniania portalu, grafiki JITEM: Derin Ağ i ikony Son Mahalle Bükücü. Provenance pending.",
      ]},
