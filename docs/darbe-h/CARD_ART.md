...
| DARBE-H! | 400×560 SVG, crisis desk / telex / dossier | `public/games/darbe-h/assets/cards/DRB-NNN.svg` |

DARBE class language: Görevli / Emirname / İhtar. Series stripe + motif. L5+ heavier frame, auxiliary wax `YD`. Readable at 360px.
...
Drop-in: `THEME_META["darbe-h"].art.kind = "svg"` and `cardArt()` picks `.svg` vs `.webp`.
