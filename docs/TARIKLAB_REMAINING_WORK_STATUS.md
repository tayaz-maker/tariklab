...
| TC SIM: DEVLET | IN REVIEW | PR açılıyor | — | Production yok. | Haritalar değişmedi (7 bölge, dış harita). Bölge zinciri: öncelik → kaynak/kapasite (uygulama < 40 ise etki %70) → hizmet açığı / kamu tepkisi (açık + 4 ay öncelik yok → gerilim +1,5, memnuniyet −0,6, uygulama −1) → sonraki dönem (memnuniyet +1). Diplomasi: vadesinde ilişki 60+ ise 6 aylık anlaşma; anlaşmadan uzaklaşma = ihlal (ilişki −4, gerilim +2); ilişki < 30 olan en çok iki taraf baskı yapar. Kayıt `geo.quiet/later/agreements`; eski kayıt boş alanla açılır. Değerler oyunun kendi soyut endeksleri. |
